...
export function aboutMeList() {
    ...
    aboutMeP2.innerText = 'Utöver att koda tycker jag om att vara med mina nära och kära, lyssna på musik, podd och se dokumentärer. När världen "tillåter" tycker jag även om att resa och gå på konsert.'
